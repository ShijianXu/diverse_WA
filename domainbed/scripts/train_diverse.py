...
if __name__ == "__main__":
    ...
    if args.dataset in vars(datasets):
        # use 1 model hparms to set the dataset
        # 2 models share the same dataset
    ...
    steps_per_epoch = min([len(env)/hparams_1['batch_size'] for env,_ in in_splits])
