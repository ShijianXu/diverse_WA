...
class Job:
    ...
    def __init__(self, train_args, sweep_output_dir):
        ...
        command = ['python', '-m', 'domainbed.scripts.few_shot_mnist_train']
...
def make_args_list(n_trials, opt_name, n_hparams_from, n_hparams, steps, data_dir, hparams, path_for_init, check_freq):
    args_list = []
