...
class Job:
    ...
    def __init__(self, train_args, sweep_output_dir):
        ...
        command = ['python', '-m', 'domainbed.scripts.train_diverse_id']
    ...
    def __str__(self):
        job_info = (
            ...
            self.train_args['hparams_seed1'],
            self.train_args['hparams_seed2'])
        return '{}: {} {} \n   {}'.format(
            self.state,
            self.output_dir,
            job_info,
...
def make_args_list(n_trials, algorithms, n_hparams_from, n_hparams, steps,
    ...
    for trial_seed in range(n_trials):
        for algorithm in algorithms:
            for hparams_seed in range(n_hparams_from, n_hparams, 2):
                train_args = {}
                train_args['algorithm'] = algorithm
                train_args['holdout_fraction'] = holdout_fraction
                        
                # two hparams seeds
                train_args['hparams_seed1'] = hparams_seed
                train_args['hparams_seed2'] = hparams_seed + 1
